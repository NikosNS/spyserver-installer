...
apt update && apt upgrade -y && apt install -y build-essential rtl-sdr librtlsdr-dev librtlsdr2 airspy libairspy-dev libairspy0 iptables wget htop tmux git iftop
